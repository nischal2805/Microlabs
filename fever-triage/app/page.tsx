  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-8">
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl p-8 mb-6 shadow-xl">
        ...
        {/* Medical Disclaimer */}
        <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-lg text-left">
      ...
      {!result ? (
        ...
        <ResultsDisplay result={result} onNewAssessment={handleNewAssessment} />
      )}
    </div>
  );
}
